        ...
        while (true)
        {
            ...
            }else
            {
                if (!home)
                {
                    ...
                    Debug.Log("RobotC: " + steps + " steps and " + turns + " turns = " + (steps + turns));
                    PlayerPrefs.SetString("ROBOTC", "RobotC: " + steps + " steps and " + turns + " turns = " + (steps + turns));
                    PlayerPrefs.SetInt("ROBOT_C", 1);
                    home = true;
                }
