...
public class RobotB : MonoBehaviour
{
    //struct declaration
        ...
        while (true)
        {
            ...
            else
            {
                if (!home)
                {
                    ...
                    Debug.Log("RobotB: " + steps + " steps and " + turns + " turns = " + (steps + turns));
                    PlayerPrefs.SetString("ROBOTB", "RobotB: " + steps + " steps and " + turns + " turns = " + (steps + turns));
                    PlayerPrefs.SetInt("ROBOT_B", 1);
                    home = true;
                }
